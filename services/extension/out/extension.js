...
const analysis_1 = __webpack_require__(2);
const auth_1 = __webpack_require__(4);
const dotenv = __importStar(__webpack_require__(51));
...
function activate(context) {
    ...
    let auth_disposable = vscode.commands.registerCommand('security-seal.authenticate', async () => {
        ...
        try {
            await (0, auth_1.authenticate)(context);
    ...
    let disposable = vscode.commands.registerCommand('security-seal.analyze_code', () => (0, analysis_1.analyzeCode)(output_channel, context));
...
const auth_1 = __webpack_require__(4);
const send_request_1 = __webpack_require__(49);
...
const pkce_1 = __webpack_require__(46);
const auth_code_listener_1 = __webpack_require__(48);
...
/* harmony export */ });
/* harmony import */ var node_process__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(41);
/* harmony import */ var node_os__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(42);
/* harmony import */ var node_tty__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(43);
...
const http = __importStar(__webpack_require__(12));
...
const packageJson = __webpack_require__(53)
